...
namespace Nintendo.Bfres
{
    ...
    public struct Decimal10x5
    {
        ...
        public static Decimal10x5 operator +(Decimal10x5 a) => a;
        ...
        public static Decimal10x5 operator +(Decimal10x5 a, Decimal10x5 b) => new(a.Raw + b.Raw);
        ...
        public static Decimal10x5 operator -(Decimal10x5 a) => new(-a.Raw);
        ...
        public static Decimal10x5 operator *(Decimal10x5 a, int s) => new(a.Raw * s);
        ...
        /// <param name="b">The second <see cref="Decimal10x5"/>.</param>
        /// <returns>The division result.</returns>
        public static Decimal10x5 operator /(Decimal10x5 a, Decimal10x5 b) => new((a.Raw << _n) / b.Raw);
        ...
        public static bool operator ==(Decimal10x5 a, Decimal10x5 b) => a.Equals(b);
        ...
        /// instance.</param>
        public static explicit operator Decimal10x5(Int32 value) => new(value << _n);
        ...
        /// instance.</param>
        public static explicit operator Decimal10x5(Double value) => new((int)Math.Round(value * (1 << _n)));
        ...
        /// instance.</param>
        public static explicit operator Decimal10x5(Single value) => new((int)Math.Round(value * (1 << _n)));
        ...
        /// instance.</param>
        public static explicit operator Double(Decimal10x5 value) => (double)value.Raw / (1 << _n);
        ...
        /// instance.</param>
        public static explicit operator Single(Decimal10x5 value) => (float)((double)value.Raw / (1 << _n));
        ...
        /// </returns>
        public bool Equals(Decimal10x5 other) => Equals(Raw == other.Raw);
    }
}
